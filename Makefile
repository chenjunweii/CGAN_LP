...
DEPENDENCIES = main.cc annotationdb.pb.cc init.hh init.h loss.hh init.hh init.h data.hh data.h cgan.hh cgan.h lp.h lp.hh network.hh network.h flt/src/file.hh flt/src/mx/layer.hh flt/src/mx/shape.hh flt/src/stl.hh flt/src/debug.hh flt/src/matrix.hh flt/src/cv.hh flt/src/mx/image.hh flt/src/mx/image.h

main: ${DEPENDENCIES}

	${CXX} ${INCLUDE} ${LIBRARY} main.cc annotationdb.pb.cc -o main -Wno-narrowing -Wno-write-strings
